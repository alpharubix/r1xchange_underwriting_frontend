        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-center p-6 bg-white border border-slate-200 rounded-xl shadow-sm text-slate-700 animate-pulse">
            ...
            <span className="font-medium text-lg">
              Analyzing your profile across lenders...
            </span>
              ...
              <div className="flex items-center justify-between mb-4 border-b border-emerald-200/50 pb-4">
                <div>
                  ...
                  <p className="text-emerald-600/80 text-sm mt-1">
                    Lenders matching most criteria
                  </p>
                </div>
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto pr-2">
                  {eligibleBanks.map((bank, idx) => {
                    ...
                    return (
                      ...
                      >
                        <span className="text-sm font-medium text-emerald-900 truncate mr-2">
                          {bank.bank_name}
                        </span>
              ...
              <div className="flex items-center justify-between mb-4 border-b border-red-200/50 pb-4">
                <div>
                  ...
                  <p className="text-red-600/80 text-sm mt-1">
                    Lenders rejecting current profile
                  </p>
                </div>
                <span className="text-4xl font-bold text-red-600 drop-shadow-sm">
                  {ineligibleBanks.length}
                </span>
              </div>
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto pr-2">
                  {ineligibleBanks.map((bank, idx) => {
                    ...
                    return (
                      ...
                      >
                        <span className="text-sm font-medium text-red-900 truncate mr-2">
                          {bank.bank_name}
                        </span>
            ...
            <div>
              ...
              <div className="flex flex-col gap-6">
                {eligibleBanks.map((lender, index) => (
                  <div
                    id={`lender-eligible-${lender.bank_id || index}`}
                    key={`eligible-${lender.bank_id || index}`}
            ...
            <div>
              ...
              <div className="flex flex-col gap-6">
                {ineligibleBanks.map((lender, index) => (
                  <div
                    id={`lender-ineligible-${lender.bank_id || index}`}
                    key={`ineligible-${lender.bank_id || index}`}
                    className="scroll-mt-6"
                  >
                    <LenderCard data={lender} />
                  </div>
