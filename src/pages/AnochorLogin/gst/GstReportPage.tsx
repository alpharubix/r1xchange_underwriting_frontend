      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-6 bg-slate-100/50 p-1 rounded-xl h-11 border border-slate-100">
            <TabsTrigger value="overview" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              GSTR Overview
            </TabsTrigger>
            <TabsTrigger value="suppliers-customers" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              Top Suppliers & Customers
            </TabsTrigger>
            <TabsTrigger value="monthly-summary" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              Monthly Summary
            </TabsTrigger>
          </TabsList>
