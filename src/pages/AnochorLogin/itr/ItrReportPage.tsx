    ...
    <div className="bg-gray-50 py-6 px-4 sm:px-6 lg:px-8 rounded-2xl border border-slate-100 shadow-sm animate-in fade-in duration-200">
      <div className="space-y-6">
        <div className="flex items-center space-x-4 mb-4 border-b border-slate-100 pb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-955">ITR Report</h1>
        ...
        <Tabs defaultValue="tax-calc" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-6 bg-slate-100/50 p-1 rounded-xl h-11 border border-slate-100">
            <TabsTrigger value="tax-calc" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              Tax Calculation
            </TabsTrigger>
            <TabsTrigger value="balance-sheet" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              Balance Sheet
            </TabsTrigger>
            <TabsTrigger value="profit-loss" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              Profit & Loss
            </TabsTrigger>
            <TabsTrigger value="ratio" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-[#FF6B4A] data-[state=active]:shadow-sm text-xs font-bold">
              Ratio Analysis
            </TabsTrigger>
          </TabsList>
